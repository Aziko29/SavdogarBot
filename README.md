...
Existing databases are upgraded automatically at startup (schema v6 adds the new order columns, v7 the inquiry tables, v8-v9 the inquiry claim columns and the card/transcript tables, v10 the saved customer details); old orders show quantity 1 and no phone/address.
