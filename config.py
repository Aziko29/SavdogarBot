...
class Settings:
    ...
    inquiry_wait_min: int = 7  # an unclaimed inquiry this long gets a "admins are busy" note (0 = off)
...
def load_settings(env: Mapping[str, str] | None = None) -> Settings:
    ...
    inquiry_wait_min = r.integer("INQUIRY_WAIT_MIN", 7, 0, 240)
    vision_hints = tuple(
    ...
    return Settings(
        ...
        inquiry_wait_min=inquiry_wait_min,
    )
